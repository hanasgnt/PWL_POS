...
@section('content')
    <div class="card card-outline card-primary">
        ...
        <div class="card-body">
            <h3 class="card-title">Sistem terbatas : hanya bisa membeli satu barang dalam satu kali transaksi</h3><br><br>
            <form method="POST" action="{{ url('penjualan') }}" class="form-horizontal">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-11">
                        @php
                            $randomString = 'PJN' . str_pad(mt_rand(1, 999), 3, '0', STR_PAD_LEFT);
                        @endphp
                        <input type="text" class="form-control" id="penjualan_kode" name="penjualan_kode"
                            value="{{ old('penjualan_kode', $randomString) }}" required>
